...
!function (e, t) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module))) module.exports = t();else if ("function" == typeof define && define.amd) define([], t);else {
    var n = t();
    for (var i in n) ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports : e)[i] = n[i];
  }
    ...
    var e = {
        ...
        219: function _(e, t, n) {
          ...
          function O(e, t, n, a) {
            ...
            for (P(n).lastIndex = 0; r = P(n).exec(e);) {
              if (void 0 === t) {
                if (o = w(r)) l += "(" + o[0] + ")", c[s] = r[0].charAt(0);else switch (r[0]) {
                  case "[":
                    l += "(";
                    break;
                  case "]":
            ...
            return void 0 !== t || "" !== n.placeholder && -1 === n.inputFormat.indexOf("mmmm") || (n.placeholder = c), l;
          }
          function _(e, t, n) {
          ...
          function j(e, t, n) {
            var i,
              a,
              r = n && n.tests[e] ? n.tests[e][0].match.placeholder : "",
              o = 0,
              s = 0;
            ...
            numeric: {
              ...
              onBeforeMask: function onBeforeMask(e, t) {
                ...
                if ("" !== n && (c = t.digitsOptional ? t.digits < l.length ? t.digits : l.length : t.digits, "" !== l || !t.digitsOptional)) {
                  ...
                  e = e.replace((0, i["default"])(n), "."), isNaN(parseFloat(e)) || (e = (t.roundingFN(parseFloat(e) * f) / f).toFixed(c)), e = e.toString().replace(".", n);
                }
        ...
        8711: function _(e, t, n) {
          Object.defineProperty(t, "__esModule", {
            ...
            var t,
              ...
              a = i.maskset,
              l = i.dependencyLib,
              c = o.getMaskTemplate.call(i, !0, s.call(i), !0, !0),
              u = c.length,
              f = s.call(i),
              p = {},
              d = a.validPositions[f],
              h = void 0 !== d ? d.locator.slice() : void 0;
            for (t = f + 1; t < c.length; t++) h = (n = o.getTestTemplate.call(i, t, h, t - 1)).locator.slice(), p[t] = l.extend(!0, {}, n);
                ...
                default:
                  ...
                  if (p <= h) e.end = e.begin = c.call(i, p, !1, !0) ? p : u.call(i, p);else {
                    var v = a.validPositions[d],
                      m = o.getTestTemplate.call(i, h, v ? v.match.locator : void 0, v),
                      g = o.getPlaceholder.call(i, h, m.match);
        ...
        7215: function _(e, t, n) {
          ...
          function l(e, t, n, i, a, s) {
            ...
            if (s && (k = s.begin, b = s.end, s.begin > s.end && (k = s.end, b = s.begin)), -1 === j && void 0 === a) c = 0, u = (d = o.getTest.call(x, c)).alternation;else for (; j >= 0; j--) if ((p = S.validPositions[j]) && void 0 !== p.alternation) {
              if (j <= (e || 0) && d && d.locator[p.alternation] !== p.locator[p.alternation]) break;
              c = j, u = S.validPositions[c].alternation, d = p;
            }
            if (void 0 !== u) {
              m = parseInt(c), S.excludes[m] = S.excludes[m] || [], !0 !== e && S.excludes[m].push((0, o.getDecisionTaker)(d) + ":" + d.alternation);
              var T = [],
                A = -1;
              ...
              for (-1 === A && void 0 !== t && (T.push(t), A = T.length - 1); void 0 !== S.excludes[m] && S.excludes[m].length < 10;) {
                for (S.tests = {}, r.resetMaskSet.call(x, !0), M = !0, h = 0; h < T.length && (g = M.caret || 0 == P.insertMode && null != g ? r.seekNext.call(x, g) : r.getLastValidPosition.call(x, void 0, !0) + 1, y = T[h], M = f.call(x, g, y, !1, i, !0)); h++) h === A && (E = M), 1 == e && M && (E = {
                  caretPos: h
                });
                if (M) break;
                if (r.resetMaskSet.call(x), d = o.getTest.call(x, m), S.validPositions = w.extend(!0, [], O), S.tests = w.extend(!0, {}, _), !S.excludes[m]) {
